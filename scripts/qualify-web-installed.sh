...
run_fixture "Studio multi-destination" python3 scripts/browser-studio-multi-destination-smoke.py "$origin"
...
run_fixture "Studio MOD art and canvas" python3 scripts/browser-studio-mod-art-smoke.py "$origin"
run_fixture "Studio art gallery" python3 scripts/browser-studio-art-gallery-smoke.py "$origin"
