...
function renderFeatureBoard(devices) {
  const catalog = [
    ...
    { match: /firebox|atomic/i, name: 'Atomic Ampli-Firebox V1', profile: 'atomic.amplifirebox-v1', source: 'Capture-backed HID evidence', features: ['USB identity', 'Report freshness', 'Reconnect state', 'Correlated telemetry', 'Read-only boundary until semantic writes qualify'] },
