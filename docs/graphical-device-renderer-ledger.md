...
| PiPedal | `pipedal` | Pedalboard/plugin graph, plugin controls, snapshots, presets, levels, MIDI ports | Pinned server operation audit; unsupported operations remain explicit | Plugin-graph SVG baseline; live catalog qualification open |
