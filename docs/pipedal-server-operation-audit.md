...
| writeTone3000Readme | catalogued | Device assets/library | confirmed bounded adapter write implemented; daemon/browser/installed qualification pending W150 |
...
| updatePresets | catalogued | Presets and snapshots | confirmed bounded adapter write implemented; daemon/browser/installed qualification pending W150 |
...
| saveBankAs | catalogued | Presets and snapshots | confirmed bounded adapter write implemented; daemon/browser/installed qualification pending W150 |
...
| setAlsaSequencerConfiguration | catalogued | Device system settings | confirmed bounded adapter write implemented; daemon/browser/installed qualification pending W150 |
...
| getAlsaSequencerPorts | catalogued | Device system settings | bounded response decoder and adapter projection implemented; daemon/browser/installed qualification pending W150 |
| requestBankPresets | catalogued | Presets and snapshots | bounded bank query implemented; daemon/browser/installed qualification pending W150 |
| importPresetsFromBank | catalogued | Presets and snapshots | confirmed bounded adapter write implemented; daemon/browser/installed qualification pending W150 |
| copyPresetsToBank | catalogued | Presets and snapshots | confirmed bounded adapter write implemented; daemon/browser/installed qualification pending W150 |
| getChannelRouterSettings | catalogued | Device session/preferences | bounded typed readback and adapter projection implemented; daemon/browser/installed qualification pending W150 |
| setChannelRouterSettings | catalogued | Device session/preferences | confirmed bounded typed adapter write implemented; daemon/browser/installed qualification pending W150 |
| DownloadModelsFromTone3000 | catalogued | Device assets/library | source payload carries PKCE credentials and download authorization context; intentionally not exposed by the bounded connector |
| cancelTone3000Download | catalogued | Device assets/library | confirmed bounded adapter write implemented; daemon/browser/installed qualification pending W150 |
