...
| 2026-08-28 | W010/W040 | executable scene action schema | implemented | Scene actions now optionally carry a named destination and bounded validated MIDI wire payload while preserving legacy metadata-only configuration; daemon execution wiring remains the next increment. |
